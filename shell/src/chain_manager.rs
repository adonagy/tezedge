...
#[actor(CheckChainCompleteness, AskPeersAboutCurrentBranch, DisconnectSilentPeers, GetHeadInfo, NetworkChannelMsg, ShellChannelMsg, SystemEvent)]
...
impl Receive<GetHeadInfo> for ChainManager {
    type Msg = ChainManagerMsg;
